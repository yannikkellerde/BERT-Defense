...
def calc_frequencys(infile="word_frequency.txt",out_file="statistics/word_frequency.pkl"):
    word_freq_dict = {}
...
def calc_statistics(infile="cmudict.aligned",out_folder="statistics",word_frequencies=None):
    ...
    for line in tqdm(lines):
        ...
        for i in range(1,len(letters)-1):
            ...
            insert_to_ngrams(gram_3,(phonemes[i-1],phonemes[i],phonemes[i+1]),(letters[i-i],letters[i],letters[i+1]),amount)
